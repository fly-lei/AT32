...
void wk_adc1_init(void)
{
  ...
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_14, 1, ADC_SAMPLETIME_13_5);
  adc_preempt_offset_value_set(ADC1, ADC_PREEMPT_CHANNEL_1, 0x0);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_15, 2, ADC_SAMPLETIME_13_5);
  adc_preempt_offset_value_set(ADC1, ADC_PREEMPT_CHANNEL_2, 0x000);
