...
#define DMA1_CHANNEL5_MEMORY_BASE_ADDR 0
  // #define DMA1_CHANNEL5_BUFFER_SIZE USART1_RX_MAX_LEN
  // #define DMA1_CHANNEL5_MEMORY_BASE_ADDR ((uint32_t)g_usart1_rx_buf)
...
#define DMA2_CHANNEL5_BUFFER_SIZE 3
#define DMA2_CHANNEL5_MEMORY_BASE_ADDR ((uint32_t)g_adc3_buffer)
...
/* Private defines -------------------------------------------------------------*/
#define LED_R_PIN GPIO_PINS_13
#define LED_R_GPIO_PORT GPIOC
#define LED_G_PIN GPIO_PINS_14
#define LED_G_GPIO_PORT GPIOC
#define LED_B_PIN GPIO_PINS_15
#define LED_B_GPIO_PORT GPIOC
#define BAT_ADC3_IN10_PIN GPIO_PINS_0
#define BAT_ADC3_IN10_GPIO_PORT GPIOC
#define TEMP1_ADC3_IN12_PIN GPIO_PINS_2
#define TEMP1_ADC3_IN12_GPIO_PORT GPIOC
#define TEMP2_ADC3_IN13_PIN GPIO_PINS_3
#define TEMP2_ADC3_IN13_GPIO_PORT GPIOC
#define MOTOR_EN_PIN GPIO_PINS_7
#define MOTOR_EN_GPIO_PORT GPIOE
#define POWER_EN_PIN GPIO_PINS_10
#define POWER_EN_GPIO_PORT GPIOD
#define SPI3_CS_PIN GPIO_PINS_15
#define SPI3_CS_GPIO_PORT GPIOA
#define SPI1_CS0_PIN GPIO_PINS_5
#define SPI1_CS0_GPIO_PORT GPIOD
#define SPI1_CS1_PIN GPIO_PINS_7
