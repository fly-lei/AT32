 ...
 */
#ifndef ELAB_DEV_NUM_MAX
#define ELAB_DEV_NUM_MAX 16
#endif
...
// typedef void (*elab_export_t)(void);
...
#define ELAB_INIT_EXPORT(_func, _level)                                             \
    ...
    __attribute__((section(".elab_init_table"), used)) =\
    {                                                                          \
        .name = #_func,                                                        \
        .func = (void *)&_func,                                                \
        .level = _level,                                                       \
...
// #define ELAB_INIT_EXPORT(fn) \
//     static const elab_init_fn_t _init_##fn \
//     __attribute__((section(".elab_init_table"), used)) = fn
